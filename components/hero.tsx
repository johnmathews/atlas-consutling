    ...
    <section className="relative">
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 md:pt-40">
         ...
         We offer full-stack data solutions including data engineering and data science, as well as python development and technical leadership. 
            </p>
            <div
            ...
            >
              <div>
                <Link className="btn text-white bg-indigo-500 hover:bg-indigo-600 w-full shadow-sm group" href="mailto:john@atlasconsulting.services">
                  Contact us{' '}
